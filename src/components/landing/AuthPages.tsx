    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-8">
      <motion.div className="w-full max-w-lg" initial="hidden" animate="visible" variants={fadeInUp} transition={{ duration: 0.5, ease: 'easeOut' }}>
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground">{T('سجل بياناتك وابدأ رحلتك معنا', 'Register your details and start your journey with us')}</p>
        </div>
        <div className="relative rounded-2xl p-[2px] bg-gradient-to-br from-gold-400 via-gold-600 to-gold-400">
          <Card className="rounded-2xl border-0 shadow-lg">
            <CardContent className="p-5">
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground mb-2">{T('اسم الطالب الرباعي', 'Student Full Name')}</p>
                ...
                <PhoneField value={phone} onChange={setPhone} placeholder={T('رقم هاتف الطالب', 'Student phone number')} id="reg-phone" error={errors.phone} />
                <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground mb-2">{T('اسم ولي الأمر', 'Parent Name')}</p>
                  <div className="grid grid-cols-2 gap-2">
                ...
                <PhoneField value={parentPhone} onChange={setParentPhone} placeholder={T('رقم هاتف ولي الأمر', 'Parent phone number')} id="reg-parent-phone" error={errors.parentPhone} />
                ...
                <p className="text-center text-sm text-muted-foreground">{T('عندك حساب؟', 'Have an account?')} <button onClick={function () { setView('auth-login') }} className="text-primary font-medium hover:underline cursor-pointer">{T('سجل دخولك', 'Log in')}</button></p>
              </div>
            </CardContent>
          </Card>
        </div>
