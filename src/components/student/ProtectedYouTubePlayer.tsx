  ...
  useEffect(function () {
    function onKey(e: KeyboardEvent) {
      ...
      if (k === 'printscreen' || e.keyCode === 44) {
        warnRecording('🛡️ الخاصية دي ممنوعة')
        try {
          if (navigator.clipboard && navigator.clipboard.writeText) navigator.clipboard.writeText('🔒 المحتوى محمي — Zicola In Math').catch(function () {})
        } catch (err) {}
      }
    }
      ...
      {!started && (
        <div className="absolute inset-0 z-30 pointer-events-none">
          {poster ? (
            ...
            // eslint-disable-next-line @next/next/no-img-element
            <img src="/images/mr-wael-cover-v2.png" alt="Zicola In Math" className="w-full h-full object-contain bg-black" draggable={false} />
          )}
